...
-- Started on 2014-04-09 09:24:04
...
ALTER TABLE ONLY message
    ADD CONSTRAINT message_from_user_fkey FOREIGN KEY (from_user) REFERENCES "user"(id);
...
ALTER TABLE ONLY message
    ADD CONSTRAINT message_to_user_fkey FOREIGN KEY (to_user) REFERENCES "user"(id);
...
-- Completed on 2014-04-09 09:24:04
